...
! function(t, e) {
            ...
            return a(t, [{
                ...
                value: function(t) {
                    ...
                    return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || C.showDelayedElements() : C.animatePathsGradually(o(o({}, E), {}, {
                        speed: g
                    })), A.globals.dataChanged && P && M && C.animatePathsGradually(o(o({}, E), {}, {
                        speed: u
                    })), z
                }
            }, {
                ...
                value: function(t, e) {
                    ...
                    for (var n = 0, l = 0; n < t.length; n++, l++) {
                        ...
                        for (var C = a.group({
                            ...
                            this.isHorizontal ? (T = this.drawBarPaths(o(o({}, I), {}, {
                                barHeight: k,
                                zeroW: g,
                                yDivision: c
                            })), A = this.series[n][P] / this.invertedYRatio) : (T = this.drawColumnPaths(o(o({}, I), {}, {
                                xDivision: h,
                                barWidth: A,
                                zeroH: d
            ...
            return a(t, [{
                ...
                value: function() {
                    ...
                    for (var o = e.globals.legendFormatter, n = e.config.legend.inverseOrder, l = n ? a.length - 1 : 0; n ? l >= 0 : l <= a.length - 1; n ? l-- : l++) {
                        ...
                        M || (M = e.config.chart.foreColor), P.style.color = M, P.style.fontSize = parseFloat(e.config.legend.fontSize) + "px", P.style.fontWeight = e.config.legend.fontWeight, P.style.fontFamily = i || e.config.chart.fontFamily, b.setAttrs(P, {
                            rel: l + 1,
                            i: l,
            ...
            return a(s, [{
                ...
                value: function(t) {
                    ...
                    for (var v = f ? t.series.length - 1 : 0; f ? v >= 0 : v < t.series.length; f ? v-- : v++) {
                        ...
                        s.setSelectionFilter(T, 0, v), this.addListeners(T, this.radialDataLabels), m.add(T), T.attr({
                            index: 0,
                            j: v
                        });
                        var z = 0;
            ...
            return a(i, [{
                ...
                value: function(e) {
                    ...
                    return new Promise((function(n) {
                        var l = [i.ctx];
                        r && (l = i.ctx.getSyncedCharts()), i.ctx.w.globals.isExecCalled && (l = [i.ctx], i.ctx.w.globals.isExecCalled = !1), l.forEach((function(r, h) {
                            var c = r.w;
    ...
    Mt = "undefined" != typeof window ? window : void 0, Tt = function(e, i) {
        ...
        })) : "object" === ("undefined" == typeof exports ? "undefined" : t(exports)) && "undefined" != typeof module ? module.exports = Mt.document ? Tt(Mt, Mt.document) : function(t) {
            return Tt(t, t.document)
        } : Mt.SVG = Tt(Mt, Mt.document),
