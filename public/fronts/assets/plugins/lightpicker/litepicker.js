...
var Litepicker = function(t) {
    ...
    var i = function() {
        function t(e, n, i) {
            void 0 === e && (e = null), void 0 === n && (n = null), void 0 === i && (i = "en-US"), this.dateInstance = "object" == typeof n && null !== n ? n.parse(e instanceof t ? e.clone().toJSDate() : e) : "string" == typeof n ? t.parseDateTime(e, n, i) : e ? t.parseDateTime(e) : t.parseDateTime(new Date), this.lang = i
        }
    ...
    var s = n(6),
        ...
        l = function(t) {
            ...
            return o(e, t), e.prototype.render = function() {
                ...
                for (x = 1; x <= o; x += 1) i.setDate(x), this.options.showWeekNumbers && i.getDay() === this.options.firstDay && P.appendChild(this.renderWeekNumber(i)), P.appendChild(this.renderDay(i));
    ...
    var r = n(7),
        ...
        l = function(t) {
            ...
            return o(e, t), e.add = function(t, e) {
                ...
                if (/left|right/.test(i[0]) || i[1] && "auto" !== i[1] && /left|right/.test(i[1])) a = /left|right/.test(i[0]) ? e[i[0]] + o : e[i[1]] + o, "right" !== i[0] && "right" !== i[1] || (a -= n.width);
                else {
                    a = e.left + o;
    ...
    function p(t, e, n, i) {
        ...
        if (void 0 === (s = t._events) ? (s = t._events = Object.create(null), t._eventsCount = 0) : (void 0 !== s.newListener && (t.emit("newListener", e, n.listener ? n.listener : n), s = t._events), r = s[e]), void 0 === r) r = s[e] = n, ++t._eventsCount;
        else if ("function" == typeof r ? r = s[e] = i ? [n, r] : [r, n] : i ? r.unshift(n) : r.push(n), (o = l(t)) > 0 && r.length > o && !r.warned) {
            r.warned = !0;
