...
let settingSwitches = document.querySelectorAll('.setting-switch');

settingSwitches.forEach(setting => {
    setting.addEventListener('change', (e) => {
        ...
        if (e.target.value == 'notification') {
            if (Notification.permission == 'granted') {
                new Notification("You will be notified soon!")
            }
        }
        fetch(form.action, {
            method: "POST",
...
let registerForm = document.querySelector('.register-form [type="submit"]');
registerForm?.addEventListener('click', (e) => {
    // console.log("Click")
    document.querySelector('.register-form')?.classList.add('validate')
})

let resetForm = document.querySelector('#resetForm')
resetForm?.addEventListener('submit', async (e) => {
    e.preventDefault()
    let url = '/api/sendPasswordResetEmail';
    ...
    if (payload.status) {
        window.location.href = '/success/change-password';
        return
    }

    document.querySelector('.email-message').removeAttribute('style')
