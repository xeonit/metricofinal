        ...
        <tr>
                ...
                <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td class="email-masthead">
                            <a href="{{ env('APP_NAME') }}" class="f-fallback email-masthead_name">
                                Me3co.com
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <h1>Hi {{ $name }},</h1>
                                            <p>You recently requested to reset your password for your {{ env('APP_NAME') }}
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                            ...
                                            <p>If you did not request a password
                                                reset, please ignore this email or <a href="mailto:suuport@me3co.com">contact
