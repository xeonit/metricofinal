                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" data-sortable=""><a href="#"
                                                        class="dataTable-sorter">Crew</a></th>
                                                <th scope="col" data-sortable=""><a href="#"
                                                        class="dataTable-sorter">Equipments</a></th>
                                                <th scope="col" data-sortable=""><a href="#"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($crews as $crew)
                                                <tr>
                                                    <td>{{ $i++ }}</td>
                                                    <td>{{ $crew->name }}</td>
                                                    <td>{{ eq_name($crew->equipment_ids) }}</td>
                                                    <td>{{ $crew->description }}</td>
                                                    <td>{{ $crew->created_at->format('d F, Y') }}</td>
                                                    <td class="text-nowrap">
                                                        <a href="{{ route('admin.crews.edit', ['id' => $crew->id]) }}"
                                                            class="btn btn-primary btn-sm"><i class="bi bi-pen"></i></a> <a
                                                            href="#"
                                                            data-action="{{ route('admin.crews.delete', ['id' => $crew->id]) }}"
