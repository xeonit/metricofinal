                                    ...
                                    <table class="table datatable dataTable-table text-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" data-sortable=""><a href="#"
                                                        class="dataTable-sorter">Company Name</a></th>
                                                <th scope="col" data-sortable=""><a href="#"
                                                        class="dataTable-sorter">Esttimator Name</a></th>
                                                ...
                                                <th scope="col" data-sortable=""><a href="#"
                                                        class="dataTable-sorter">ZIP Code</a></th>
                                                <th scope="col" data-sortable=""><a href="#"
                                            ...
                                            @foreach ($companies as $company)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('admin.company.edit', ['id' => $company->id]) }}"
                                                            ...
                                                            href="#"
                                                            data-action="{{ route('admin.company.delete', ['id' => $company->id]) }}"
